...
After getting to work on his second day, Tonttu quickly downlaoded the Carton module's tarball.
...
The nisse started to do some testing and cooked up the follow proof of concenpt for Santa for the first part:
...
If no errors You may remove the C<vendor/> directory (optional).
