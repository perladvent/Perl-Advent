...
Topic: Use 'all' packages from the namespace at once

=encoding utf8

=head1 Let the Elves Import Your Packages

Same as every year, last days before Christmas are very busy for the Elves.
Those little tinkers are best known for hand-crafitng all the presents kids
...
At around 2003, Santa he managed to spy on the Elves to figure out how they do
...
which he spent a lot of his free time on. The project grew and grew, and Timmy
...
all failed, he searched for two hours trying to figure out what's wrong with
the module.
