...
In order to implement the counter of the odometer, an elf came with this code:
...
After asking some more experienced elf, the elf decided to implement a persistent variable via a "lexical trick":
...
These 2 previous pieces of code works well, but there is definitely a simpler way! 
