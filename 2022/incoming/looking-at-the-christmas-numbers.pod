...
New York Fashion Week say? Maybe something like: how lame - I want a gradient from
I<Glacier Lake> to I<Harbor Blue>. Alright, let's check quickly if 
L<Graphics::ColorNames::Pantone> is installed and lets create our own three color
gradient with the colors from this summers I<Pantone Report>. (Other standards
like I<X>, I<HTML> or I<VACCC> are available too - just look at L<Bundle::Graphics::ColorNames>).
