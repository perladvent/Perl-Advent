...
Title: Silent Mite
Topic: Zero-Dependency Object Oriented Programming with Mite
...
lunch room emerged and hurried down the hall. A booming voice came from
...
No third party code unless it has a warranty."

"Legal," grumbled the old man. "You know last year they tried telling me
I can't drink an alcoholic drink at almost every house I stop at while
I'm sleigh driving. Bunch of killjoys. Are you using the metaobject
protocol?" Santa asked, displaying a knowledge of programming that Ernest
was surprised by.
...
Mite. It depends on Robot::Alien::Ninja::Mite, which is about 300 lines
...
"Of course, aliens," said Santa. "Think about it this way. You use, what,
