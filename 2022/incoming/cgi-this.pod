...
Quite a few of their internal tools with web interfaces were originally written using L<CGI>, and despite the
ongoing effort by the elves to port them over to L<Plack>, several of the more critical tools
remain. After all, why change a running system?
...
The two remaining original CGI elves thing this is not neccessary, because they could of course make these
