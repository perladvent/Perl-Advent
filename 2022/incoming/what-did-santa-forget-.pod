...
Topic: Diff two Perl structures

=encoding utf8

=head1 What did Santa forget?

Santa is about ready to start his yearly trip around the world! But does he
I<really> have everything?

Would be silly not to deliver a present to someone who has been trying the
whole year to be nice. Luckily, to avoid such blunder, he made a list
beforehand:
...
Now all he needs to do is compare it to the list of things he packed. He asked
...
Now with everything in place, it's about time to make the delivery...
