...
You can use C<Spreasheet::ParseExcel> for reading the older Excel files having C<.xls> extension, on the other hand you should use C<Spreadsheet::ParseXLSX> or C<Spreadsheet::XLSX> to open and manipulate existing Excel files. This article deals with creating Excel files in C<.xlsx> format.
