...
Confused but lazy, he searched the L<MetaCPAN|https://metacpan.org/> for a solution and went with L<Acme::Base64>:
...
You should never feed L<Gremlin|https://en.wikipedia.org/wiki/Gremlins> after midnight but you also need to monitor closely the maple syrup consumption of elves!
