...
When modelling family relations, Ježíšek used trees. The description
of a tree structure is tricky, though, as it leads to a cyclic
reference, which causes a memory leak:
...
Niño Diós wasn’t the only one to encounter the problem. See for
...
releasing them, and L<GoodData|https://gooddata.com/> for sponsoring
open source.
...
(L<video|https://www.youtube.com/watch?v=KrGSg7uVZj0&t=10590s>,
