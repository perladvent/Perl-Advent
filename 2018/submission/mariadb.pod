...
To connect to the MySQL database from Perl, one always used the
L<DBD::mysql|https://metacpan.org/pod/DBD::mysql> module. It worked
with the MariaDB fork, too.

Recently, the new module
L<DBD::MariaDB|https://metacpan.org/pod/DBD::MariaDB> has been
released. Has it confused you? Which one should you use?
...
Currently, there are 158 different combinations.
