...
Today was a big day for Gnomo Knullpöinter. They had recently started a new
...
C<send_gift(...)->get> for a bit, and I still have no idea what it does. And
don't even get me started on having ... futures that wait on other futures?".
