...
It's possible to compile C code using L<Emscripten> to produce JavaScript code
...
This all sounds like a lot of work - or would be, if the L<webperl
project|https://webperl.zero-g.net/> hadn't done all the hard work for us
...
Assuming you're reading this article with a recent web browser then this
code is entirely runnable directly L<fib.html|in the browser>.
