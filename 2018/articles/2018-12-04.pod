...
"Now I all know what you're thinking", Buddy continued, "but listen to me for a
second."
...
string.  What other character might our terminal get confusd with Tiny Plumhat?"
...
internal like things with Perl.  And one of the things it has is get a
...
"And that print out something - if not nice, since we didn't gave it such
