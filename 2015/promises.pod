...
=item 2nd: DONE: Shoichi Kaji's App::cpm article
...
=item 8th: DONE: James' Reply article

=item 9th: DONE: Yanic's Web::Query article

=item 10th DONE: Mark's CPANFILE article

=item 11th: DONE: Neil Bower's article

=item 12th: DONE Reserved for fREW's article

=item 13th: DONE Reserved for Yanick's JSON::Path Article

=item 14th: DONE: Mark's Acme::MetaSyntactic article

=item 15th: DONE: Yanick's File::Serialize article

=item 16th: DONE: Dave Rolsky's article

=item 17th: DONE: rjbs's article

=item 18th: DONE: Ivan's article

=item 19th: DONE: Olaf's article
...
=item 21st: DONE: Mark's feature article

=item 22nd: DONE: Marcus' article

=item 23rd: DONE: Mark's article on Mojo::UserAgent

=item 24th: Reserved for Paul Evan's Article

Paul is working on an article on Hardware with Perl.  Mark may need to write
a little of this.

POTENTIAL WORK FOR MARK HERE
