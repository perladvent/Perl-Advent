...
=item There are nineteen promises to write an article

=item There are ten articles planned
...
=item Mark Fowler: Code::Tidyall

an article on setting up code tidy and writing your own plugins
