...
=item There are two articles delivered and in the queue

=item There is one article delivered pending being moved in the queue

=item Mark has written and committed one articles so far

=item There are three promises to write an article but not planned

=item There are sixteen articles planned
...
Is gonna write about Text::Hogan
...
Chased via a Slack on 2015-11-10
...
Status: Chaser irc message sent 2015-11-10

=item Dave Cross

Dave was going to write about Lingua::EN::Inflexion

Chaser irc message sent 2015-11-10.  Said "You'll have to wait till the weekend".
...
Chased via email 2015-11-10.  Replied 2015-11-10 saying "before the week is over"

=item Neil Bowers

Is going to write about Smart::Comments

Chased via email 2015-11-10.  Replied 2015-11-10 saying "Ah, er, I’ll reply to this email later this evening"
...
Chased by a Slack on 2015-11-10
