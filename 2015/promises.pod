...
=item 8th: Reserved for Mark's CPANFILE module

Mostly done, needs the once over

WRITING WORK FOR MARK HERE

=item 9th: Reserved for Neil Bower's article

=item 10th: Reserved for fREW's article

=item 11th: Reserved for Yanick's JSON::Path Article

Basic article in, needs spiffing up

WRITING WORK FOR MARK HERE

=item 12th: Reserved for Mark's Meta::Ssyntatic article

WRITING WORK OFR MARK HERE

=item 13th: Reserved for Yanick's File::Serialize article

Basic article in, needs spiffing up

WRITING WORK FOR MARK HERE

=item 14th: Reserved for Dave Rolsky's article

=item 15th: Reserved for rjb's arcticle

=item 15th: Reserved for Mark's feature article:

WRITING WORK FOR MARK HERE

=item 17th: Reserved for Ivan's article

The first draft of this is in, I just need to rework it

WRITING WORK FOR MARK HERE

=item 18th: Reserved for Olaf's article

=item 19th: Reserved for rjbs's article

=item 20th: Reserved for Maxim Vuets 

=item 21st: Reserved for Marcus' article

Currently AWOL.  May need replacing.

=item 22nd: Diego Kuperman

Currently AWOL.  May need replacing.

=item 23rd: Reserved for 松木雅幸's article
...
Wrote about Convert::CookingTimes

=item Graham Ollis

Graham wrote about FFI::Platypus 

=item Yanick Champoux: Web::Query

Mostly reworked and in
...
=item Yanick Champoux: JSON:Path

=item Yanick Champoux: File::Serialize

=item Ivan Kruglov

Is going to write about Sereal

Last contact 2015-11-08 saying he'd send over his first draft that evening.  Chaser sent 2015-11-15.  First draft in 2015-11-15.
