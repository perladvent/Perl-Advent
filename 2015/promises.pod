...
=item Six articles have first draft written

=item Ten articles are actively being worked upon (three by Mark)

=back

In total B<NINETEEN> articles have reasonable chance of delivery if Mark does nothing (but write articles he's working on)

Potential Other Articles include:

=over

=item Five articles were planned but authors are currently AWOL

=item Two authors promised to write an article, but haven't planned anything

=back

There are B<SEVEN> more potential sources of articles therefore, taking us to B<TWENTY SIX> articles.
...
Last contact 2015-11-08 saying he'd send over his first draft that evening.  Chaser sent 2015-11-15.
