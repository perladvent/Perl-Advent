...
=item Seven articles have first draft written

=item Ten articles are actively being worked upon (three by Mark)

=back

In total B<TWENTY> articles have reasonable chance of delivery if Mark does nothing (but write articles he's working on)
...
=item Two authors promised to write an article, but haven't planned anything

=back

There are B<SIX> more potential sources of articles therefore, taking us to B<TWENTY SIX> articles.

(That's an article each day, including one on Xmas day - the feature article might make a good choice - and one spare)
...
Chased via email 2015-11-10.  Rechased 2015-11-15.  Said will have something by 2015-11-18
...
Chased via email 2015-11-10.  Rechased 2015-11-15.
