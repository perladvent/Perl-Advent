...
Easters Bunny is notoriously known to be the biggest elf poacher around)
...
slowly moving up the yuletide ladder until E<8212> know knows? E<8212> he makes
...
canonical representation) based on the filename the script was writing to:
...
to implements a small pipeline (or, in devI<elf>oper lingo, a garland) 
