...
temporarily take one node out of the loadbalancer to do upgrades, so that every
...
with the adhoc ansible command:
...
that as an excercise for you to figure out. We forgot something though. Earlier,
