...
Only then, in evitably, you can't put down the glue bottle.  It's not that you've gone
...
Well, the abstratction leak in our Perl glue layer might not be so bad, but it's
...
Speaking of things we even Perl vetrans fail to notice:  When the code
...
We I<also> also probably don't catch the situtations where we might care about
