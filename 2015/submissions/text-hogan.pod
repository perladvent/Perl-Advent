...
=for html
 <ol>
  <li>If I filter the text is in German, but if I hit F5 it's English</li>
...
grepped as hard as they could around C<lib/SantasWorkshop/> but the table logic
...
When Santa talked to his team leads about the projects they were working on that
week he heard about the bugs, and the likelihood of regressions, his
