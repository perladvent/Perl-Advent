...
use L<different tools|2011-12-15.html> for that.)
...
C<L<cpandoc|2011-12-15.html>>) to only being available when you can access web
pages, you're in line for some hard times.  Having the man pages available as
HTML is really tempting, though.  Not only do they look quite, nice, but their
interlinking becomes very useful.  L<Pod|perlpod> is a format with decent
facilities for linking to other documents, but the C<perldoc> makes those links
pretty worthless.  In HTML, they become an asset.
