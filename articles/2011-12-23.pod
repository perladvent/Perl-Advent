...
…but it's still not perfect.  For one thing, some chucklehead might has blessed
his object into C<ARRAY>.  Frankly, I think that if you've got that going on in
your code base, you probably deserve what you get, but you can protect against
it, any many do, with:
