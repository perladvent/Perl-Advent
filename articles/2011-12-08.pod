...
that your L<Awesome::Library> is busted on 5.8.9?
...
L<local::lib|2011-12-01.html> for that.  Maybe, though, you want the same
version with different options.  These are all useful:
