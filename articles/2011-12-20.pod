...
rather frustrating. In xUnit style testing, test isolation (a _very_ good
...
declarative. What would be rather handy, I said to Ric, would be if I could
...
Test::Routine. Ric agreed that that would be cool, but that he wasn't in a
...
having a play, you can pull the latest version from my github fork of
Test::Routine at http://github.com/pdcawley/Test-Routine. Enjoy yourselves.
