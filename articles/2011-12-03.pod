...
To avoid these kinds of mistakes, one policy – and one do which I often adhere
...
statements above namespace::autoclean, they'd all be purged and wouldn't be
callable as methods.
