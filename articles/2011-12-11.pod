...
general-purpose web client for Perl was
L<LWP::UserAgent|https://www.metacpan.org/module/LWP::UserAgent> (Library-WWW
for Perl). That library has been around for a long time, has many things built
on top of it, and is actively maintained.

I like writing web clients, and I’ve used L<LWP::UserAgent> for years. I’m used
