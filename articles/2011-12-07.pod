...
Symbolic references? Typeglobs[1]? We I<can> rewrite this in a way that is
L<strict>-safe:
...
typeglobs and the storage representation of stashes[2], and makes these sorts
...
[1] No, I'm not going to go into typeglobs here - for the purposes of this
entry, you can think of them as "magic", or look them up in C<perldoc perldata>
if you're especially curious.

[2] For instance, does the output of C<< perl -e'package Foo; sub bar () { 1 }
use constant BAR => 1; use Data::Dumper; warn Dumper(\%Foo::)' >> surprise you?
