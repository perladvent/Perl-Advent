...
There are also a few other current open projects from both academia and the developer community: (geolocate from Tulane University, CLAVIN - Cartographic Location And Vicinity INdexer, and mordecai https://github.com/openeventdata/mordecai ) 
