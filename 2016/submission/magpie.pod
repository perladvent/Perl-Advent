...
setup the pipeline Machine for the application. The C<match> directive matches
...
any string in curly branches and replace it with the appropriate translation.
