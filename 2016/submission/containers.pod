...
Linux containers are a hot topic these days. This is why I decided to share with you, how you can interract with containers directly from Perl.
...
L<Linux::Clone> - to create a new container.
...
In entirely new namespace, the above script should return an empty list. On a normal laptop/desktop machine, if creating a new IPC namespace was unsuccessfull it should give you a list with a few entries in it.
