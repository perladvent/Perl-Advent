...
the UK department, named L<C<wish-uk.csv>|../share/static/wish-uk.csv>:
...
the L<simple way|../share/static/wish-uk-1.pl>:
...
The master elf suggested to L<use the headers|../share/static/wish-uk-2.pl>:
...
decided that they just wanted to count on the first part of the postal code, so
they amended the L<script||../share/static/wish-uk-3.pl>:
...
They had a long session on how to match the wish description with the
present data they had, and came up with L<what they think was accurate
enough|../share/static/wish-uk-4.pl>:
...
To get the right data to production they still need the present properties
in order to categorize the presents. This turned out to be very
L<easy|../share/static/wish-uk-5.pl>:
...
The L<Dutch sent Santa|../share/static/wish-nl.csv>:
...
The L<Germans sent Santa|../share/static/wish-de.csv>:
...
can read all wish-list files in a single loop and L<collect all required
data|../share/static/wish-xx.pl>:
