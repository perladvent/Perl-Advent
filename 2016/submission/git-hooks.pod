...
continuous integration server, or trigger a rebuild of the web site.
...
Be that as it may, C<Git.pm> provides a Perl interface for running git. After adding C<use Git;> at the beginning, we will insert these new two lines
