...
* 4. do the diff between the two list to guess the unused functions
  ...
  Then perform an analysis on the updated document.
...
we can build the list of functions used as barewords.
...
=head2 Combining everything together
