...
=for html
    <ol>
        <li>6 Major Work Segments</li>
        <li>Upto 6 different legal entities</li>
        <li>3 type of estimates</li>
        <li>Purchase Order</li>
        <li>3 Type of Release Orders for handle media communication</li>
        <li>3 Type of invoicec</li>
    </ol>
    
=head2 Challenges

Then we were in search of suitable PDF production module. We looked for: 

=for html
    <ol>        
        <li>The module suits to tailor build the document</li>
        <li>The module should give production control in pixel level </li>
        <li>Implementation of different legal entitie based letterpad</li>
        <li>Option to implement signatures</li>
        <li>Position control to handle page continuation</li>
    </ol>

After a lengthy search for few days, we finally zeroed in PDF::Reuse. It did not have user friendly function wraps for graphic output, but it offered a developer friendly core functions to control in a pixel level. It helped to wrap our custom functions to match generic needs.
