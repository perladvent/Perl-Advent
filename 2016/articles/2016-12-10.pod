...
the UK department, named L<C<wish-uk.csv>|wish-uk.csv>:
...
The master elf suggested to L<use the headers|wish-uk-2.pl>:
...
they amended the L<script||wish-uk-3.pl>:
...
The L<Dutch sent Santa|./wish-nl.csv>:
...
The L<Germans sent Santa|wish-de.csv>:
