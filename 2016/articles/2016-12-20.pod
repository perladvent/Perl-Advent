...
Estimate E<8407> Purchase Order E<8407> Invoice cycle, with Detail, Rate, Qty
...
It will produce a title <b>Production Estimate</b> in page center.  A data
    ...
    sub header_text{
      ...
      for my $key ( sort { $a <=> $b } keys %{ $data } ){
        ...
        for my $row_data (@{ $chunk->{data} }) {
            ...
            $y -= $chunk->{line_height} || $page->{line_height}; # reflect current y position
...
gave us a business. <b>Thanks PDF::Reuse</b>.
