...
our application to function?  And what would we like the corrisponding code to
look like?
...
parameters. If validation fails, the error messge and usage should be generated
...
The the same happens for the parameter C<city>. Now the app takes
