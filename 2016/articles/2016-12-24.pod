...
using L<Test2::Suite|https://metacpan.org/release/Test2-Suite>, which provides
a rich set of tools for testing data structures, objects, and more. Even
better, it provides really nice output when a test fails.

Let's start with some tests for C<Grinch::Netfiltrator>. It has a method named
C<find_nile_servers> that scans the entire Internet to find servers owned by
Nile. Let's not worry about how it does that, we'll just look at the tests for
...
L<Test2::Bundle::Extended|https://metacpan.org/pod/Test2::Bundle::Extended>. We
put these all together to declaratively define what we expect a complex data
...
So what happens if a check fails? The
L<Test2::Suite|https://metacpan.org/release/Test2-Suite> tools give us very
...
good. In fact, L<Test2::Suite|https://metacpan.org/release/Test2-Suite> will
warn you about this and suggest some ways to fix it.
...
change I needed to update the tests as well. Fortunately,
L<Test2::Suite|https://metacpan.org/release/Test2-Suite> has tools for testing
objects as well. Here's what our test looks like now:
...
L<Test2::Suite|https://metacpan.org/release/Test2-Suite>. This distribution
has a variety of helpers for checking definedness, whether elements of arrays
and hashes exist or not, doing regex checks, and much, much more. And you can
extend it simply by writing your own class which inherits from
L<Test2::Compare::Base|https://metacpan.org/pod/Test2::Compare::Base>.

My experience when using
L<Test2::Suite|https://metacpan.org/release/Test2-Suite> to test The Grinch's
hacking tools has been great. The expressive declarative testing syntax,
combined with the excellent output on failures, has helped me find and fix
dozens of bugs. I think that The Grinch is going to steal Christmas in a big
way this year!
