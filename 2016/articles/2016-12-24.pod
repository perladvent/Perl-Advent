...
definedness, whether elements of arrays and hashes exist or not, doing regex
checks, and much, much more. And you can extend it simply by writing your own
class which inherits from L<Test2::Compare::Base>.
