...
The trouble is the expressions like this aren't what is aren't a "Type-3"
...
Perl, on the other hand, has a more powerful regular expression that can handle
