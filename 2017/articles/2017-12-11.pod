...
Path::Tiny is a tiny abstraction around file paths that make it very easy to
...
this aritcle - including reading directory contents (or iterating over them via
