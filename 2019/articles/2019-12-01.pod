...
delivery this year, after a prank they'd been involved in with taking over
...
unlocked his desk draw and pulled out a dogeared post-it note.  "I wrote
...
hacked by some young miscrents, but they'd done it just by guessing
...
michevious agents.  It's not enough to switch an C<1> for an C<i> or
...
algorythm that can do just that.  And there's a Perl implementation
on the CPAN. 
...
undeserving hooligans....at least until till tomorrow....