...
=head2 Action Shot!
  ...
  my $concat = $d->get(
     $dbh,
     'dbi:ODBC:server=10.6.6.17;database=Lynx;driver=SQL Server Native Client 11.0',
     'concat_sql',
  );
...
should support some major databases.  This code from the L</Action Shot!> is
probably sufficient:
