...
individual pixels. But as you scale up the image, there will come a point
...
This just calls various lower-level methods which draw the individual shapes
...
remembered the existence of C<MooseX::Getopt> which did all of that for her.
