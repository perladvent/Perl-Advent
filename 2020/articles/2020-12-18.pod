...
AppleScript is a very odd bespoke programming language designed to have a
...
the OAuth process that grants my developer application the contexts (the privileges)
