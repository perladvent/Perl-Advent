...
=item There are one articles delivered pending being moved in the queue

=item Mark has written and committed nine articles so far

=item There are six promises for articles outstanding

=back

  perl -E 'say 24 - (4 + 1 + 9 + 6)'
  4
...
=item There are two articls Mark is fairly confident he can complete

=back

  perl -E 'say 24 - (4 + 1 + 8 + 6 + 2)'
  2
...
Has been stupid enough to promise another article.
