...
=item There are ten articles delivered and in the queue

=item There are zero articles delivered pending being moved in the queue

=item Mark has written and committed ten articles so far

=item There are three promises for articles outstanding

=back

  perl -E 'say 24 - (10 + 0 + 10 + 3)'
  1

=over

=item There is one article Mark is fairly confident he can complete

=back

  perl -E 'say 24 - (10 + 0 + 10 + 3 + 1)'
  0
...
Said "will see if I can scare out one more myself".  That sounds like
a promise to me ;-)
