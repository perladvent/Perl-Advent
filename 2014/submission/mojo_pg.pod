...
DBD::Pg driver:
  ...
  #!perl
  # connect as user 'two' with password 'turtle' to the 'partrige'
  # database running on port 5432 on the 'dove' server
  my $pg2 = Mojo::Pg->new('postgresql://two:turtle@doves:5432/partrige?RaiseError=0&PrintError=1');
...
The ability to for Mojo::Pg::Result to return the data structure in collections
