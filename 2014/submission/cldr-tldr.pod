...
More complex uses include localized lists of ranges of dates using the local
calendaring and numbering systems.
...
Here’s an example of simple number formatting:
...
change the results of even simple number formatting. Now let’s see this applied
to prices in different currencies.
...
=for :list
* L<Locales> provides much of the simple CLDR data, such as names of countries and languages.
