...
"Why", asked the Wise Old Elf, "are there three seperate Santa users in the
production database?"
...
don't have to write the SQL if you don't want to.  Test::Database row is able
...
and then compare in within Perl to see that the tests match. Because C<Claws>
