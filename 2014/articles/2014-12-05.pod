...
to read stacktraces which make your code hard to debug.  One simply solution
is to manually name all your anonymous subroutines using a the handy
Sub::Util module
...
There's a standard trick that you can do in Perl to do this called a Swartzian
transform to avoid this:
...
And now when we run out code we get this:
