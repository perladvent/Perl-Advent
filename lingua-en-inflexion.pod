...
Lingua::EN::Inflect is now in maintenance mode and has been superceded
by a new module called Lingua::EN::Inflexion which claims to be more
powerful and to have a more flexible interface. It's written by Damian
Conway, so those claims seem likely to be accurate. I settled down to
...
"inflect()" and that's the one which solves our problem and gives us
our "quick win".
...
tag, "<A:...>" which can be used for adjectives, as you can see in this
...
was obviously getting bored of writing all of that code time he
