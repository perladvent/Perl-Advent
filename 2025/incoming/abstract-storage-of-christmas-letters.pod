...
=for :html
  <img src="christmas-letters.png" alt="Children writing Christmas letters">
...
anyway, so he might as well write it as a Storage::Abstract driver.
...
L<Storage::Abstract> had more cool tools at its disposal that could prove
...
stable version. Thanks to the elf's work, every child I<should> get their present
this year!
