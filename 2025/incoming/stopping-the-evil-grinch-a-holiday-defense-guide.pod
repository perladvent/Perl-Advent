...
=for :html
<img src="elf_runnig_perl_script.png" alt="Stopping the Evil Grinch" style="float: right; margin: 0 0 1em 1em; width: 300px;"/>
...
At this point, the magical script was running the reports. The final step was to send them via email. The elves created a Gmail app password and stored it in a protected C<.mail_env> file:

  #!vim bash
  chmod 600 .mail_env

Then they created C<SendMail.pm> inside the C<lib> folder:
