...
it, which could be as easy as list of files he wanted to modify:
...
Frosty had a long look at that output. Script inspected his actual production
...
root. For example, this is how C<deploy.sh> script looked like:
