...
=head2 🎁 And Now: How You Can Use Melian
...
would be C</var/db/melian/gifts.db> or using MySQL/MariaDB/PostgreSQL.
...
=item * It's identified with the ID C<1> (we could pick any number)
...
By default, it listens on the UNIX socket C</tmp/melian.sock>.
