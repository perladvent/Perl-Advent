...
=for :html
<img src="santa.png" alt="Santa!" style="float: right; margin: 0 0 1em 1em; width: 300px;"/>
...
Anyway, he was fine with playing his individual instruments, by themselves, for a long time. He is old fashioned, you know. But this year he decided to hook everything together with MIDI ("Musical Instrument Digital Interface") and play his superior Arturia. (A Christmas present to himself, recently.) So he got the necessary cables and connected his synthesizers and computer.

Now with a "digital audio workstation" app ("DAW"), you can orchestrate all your external MIDI instruments and record a masterpiece. But you can B<also> control everything with Perl programs!

=head2 North Pole Perlers
