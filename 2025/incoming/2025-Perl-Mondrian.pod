...
L<Moo|https://metacpan.org/pod/Moo>, mostly because I like Moo, and it makes this
...
Now, L<Perl::Critic|https://metacpan.org/pod/Perl::Critic> fusses at me here about redefining C<$x> in the same lexical scope. Which
I did, even though I was done with the B<first> C<$x>. To keep the Critic and 
L<Test::NoWarnings|https://metacpan.org/pod/Test::NoWarnings> happy,  
let's redo this with some lexical blocks:
