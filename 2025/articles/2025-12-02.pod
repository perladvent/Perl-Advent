...
The NaughtyOrNice dashboard wanted 16:9. The old in-house bulletin board insisted on 4:3.
...
Santa in front of the Northern Lights, reindeer in flight, close-ups of toys, and the
...
web app. The details are in the 
L<DOCKER.md|https://github.com/davorg-cpan/app-blurfill/blob/main/docker/DOCKER.md>
file on GitHub, with copy-and-paste commands for pulling and running the
