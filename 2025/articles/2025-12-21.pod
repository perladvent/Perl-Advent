...
This code worked perfectly for ages, yet recently it stopped feeding Rudolph.
...
When children learn to read they don't read words as whole units. They decode letters, syllables, fragments.
...
=item What if these values form lists that are too long?
...
This kind of document always sparks heated discussions so I've created a GitHub project
...
It should spark the creation of some kind of I<base class>, some kind of I<readability framework>,
