...
Imagining you're cooking. You wouldn't wait for the water to boil before you
...
the previous C<begin>. With all C<begin> calls C<end>ed, it will return to the
...
safer way to call C<time> when running in an event loop.
