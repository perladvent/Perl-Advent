...
but writing code using L<http://template-toolkit.org/|Template Toolkit>'s
DSL can be limiting.)
...
The point is that using those to run a blog may seem wasteful, as there's
...
L<wallflower|http://metacpan.org/module/wallflower> is a command-line
...
The point of Wallflower is to let you write any static website using
...
A simple call to File::Find will help us generate the list of all posts,
