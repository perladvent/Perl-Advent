...
Perl v5.14 added the L<the r flag for the substitution operator|https://www.effectiveperlprogramming.com/2010/09/use-the-r-substitution-flag-to-work-on-a-copy/>. When I use that, the bound string is unmodified but I get the modified version of the
...
In the last year I'm been particularly keen to clean up areas where I'm passing around too much data. Instead of using a "god" hash with lots of irrelevant keys, I extract just the parts I need to nothing gets more than they should be allowed to use:
