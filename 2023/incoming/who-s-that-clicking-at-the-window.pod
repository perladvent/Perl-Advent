...
"Look, " said Sugarplum eagerly,"Its looks so pretty, and you can move this arrow every where!",
...
even make the characters green", said Sugarplum desparately trying to make a case for new technology,
...
=for :html
<div style="text-align: center;"><img width="800" src="share/static/UI.png"></div>
...
Making a UI was one thing, but tying actions to the widgets is quite another.  How woud you code
the functions trigegerd by user interactions with the interface?  Well passing "a" 
...
This is only required once, and the assist can be switched off by revertong to "q",
...
Static Texts can be changed by using thir IDs
...
young Alabaster, the elf with advanced graphical interface opowers could easily beautify once
