...
=head2 SYNOPSIS
      ...
      $ timidity -Od jingle-bells.pl-fancy.mid  # for unix-like systems

=head2 PLAYBACK

=head3 On Windows

On Microsoft Windows, you have to use the Legacy Media Player. This
app just works. MIDI support was removed from the current Microsoft
Media Player app.

=head3 On everything else
...
=for :list
* L<The code|https://github.com/ology/Music/blob/master/jingle-bells.pl>
* L<MIDI::Util>
* L<Music::MelodicDevice::Inversion>
* L<Music::MelodicDevice::Transposition>
* L<https://timidity.sourceforge.net/>
* L<https://www.videolan.org/vlc/>
