...
build your attributes easier and giving them meaning. It's not by any means a
...
shortcuts, but the core functionality alone should immensly improve the code
