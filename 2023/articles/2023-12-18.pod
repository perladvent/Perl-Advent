...
The elves workshop has been as busy as ever this year. To help
them pass the time when not gossiping or recounting heroic
pranks of Christmases passed, old graybeard Igvik the elf
has been piping music from his computer in the utility room
to the office, canteen and tool benches using cabling left
over from an obsolete phone service.
