...
This will create a file in your current directory called C<Bakerloo.png>.
...
Or, if you're feeling adventurous and want to explore all the maps, use the distribution L<Task::Map::Tube|https://metacpan.org/pod/Task::Map::Tube> to install them all at once.

=begin code

    $ cpanm -v Task::Map::Tube
