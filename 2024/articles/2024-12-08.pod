...
for each artist the user has listened to between the minumum and maximum
...
syntax (and even with Moo or Moose) you would print an attribute with code
like this:

    say "The name is ", $self->name;
