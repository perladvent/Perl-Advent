...
=for html
<img src="valiant_logo.webp" height=200 width=200 style='float:left' />
...
So when using L<Valiant> you have a lot of options for describing validaion rules.  These can
